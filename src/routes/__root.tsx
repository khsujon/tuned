...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium sound system rentals, live audio engineering, and full event production serving DC, Maryland, and Virginia." },
      { name: "author", content: "Tuned" },
      { property: "og:title", content: "Tuned — Audio Services | Pro Sound Rental in the DMV" },
      { property: "og:description", content: "Premium sound system rentals, live audio engineering, and full event production serving DC, Maryland, and Virginia." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Tuned — Audio Services | Pro Sound Rental in the DMV" },
